...
namespace WADFinal.Controllers
{
    public class ReviewerController : Controller
    {
        private SearchAppContext db = new SearchAppContext();
        ...
        public ActionResult Create([Bind(Include = "ReviewerId,User,Password,LoggedIn")] Reviewer reviewer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewerId,User,Password,LoggedIn")] Reviewer reviewer)
        {
            if (ModelState.IsValid)
            {
